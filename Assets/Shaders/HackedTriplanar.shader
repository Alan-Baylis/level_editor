...
#include "UnityCG.cginc"
	...
	void GetTriplanarTextures(float3 worldPos, float3 worldNormal, out fixed4 albedo, out half3 normal) {
		...
		albedo = xAlbedo * projNormal.x + yAlbedo * projNormal.y + zAlbedo * projNormal.z * 0.9;
	}
	ENDCG
